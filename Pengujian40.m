...
target(1:40) = 1; % Lemon
target(41:80) = 2; % Nipis
target(81:120) = 3; % Sunkist
...
disp(['Kelas 1 (Lemon): ', num2str(presisi(1))]);
disp(['Kelas 2 (Nipis): ', num2str(presisi(2))]);
disp(['Kelas 3 (Sunkist): ', num2str(presisi(3))]);

disp('True Positives (TP) untuk setiap kelas:');
disp(['TP Kelas 1 (Lemon): ', num2str(TP(1))]);
disp(['TP Kelas 2 (Nipis): ', num2str(TP(2))]);
disp(['TP Kelas 3 (Sunkist): ', num2str(TP(3))]);

disp('False Positives (FP) untuk setiap kelas:');
disp(['FP Kelas 1 (Lemon): ', num2str(FP(1))]);
disp(['FP Kelas 2 (Nipis): ', num2str(FP(2))]);
disp(['FP Kelas 3 (Sunkist): ', num2str(FP(3))]);
